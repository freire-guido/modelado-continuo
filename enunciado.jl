...
function optimizar_params(f, p₀, tf, loss, solver, x₀ = nothing; lb = nothing, ub = nothing, generator = Optimization.STANDARD_PROB_GENERATOR, maxiters = 1000)
	if x₀ == nothing
...
# TODO
# prob_x0, p_x0 = optimizar_params(SIR, [0.001, 0.5, 0.5], tf1, costo(tf1, weekly_cases, 2), SAMIN, [0.999, 0.001, 0],
# 		lb = zeros(3), ub = [0.001, 100, 100], maxiters = 50000)
...
# ╔═╡ 774d0120-d81f-4a12-b7e5-318e0fef14cc
p_SIR

# ╔═╡ 7190e0c3-0ebb-4c2a-86c9-f887db07b992
p_SEIR
...
# ╔═╡ 6c903fc8-ffd6-4b74-bf34-dda78b4e50a0
md"""
## _Costo_

Claramente SEIR ajusta un orden de magnitud mejor que SIR. Además se ve en el gráfico que SEIR captura la ola y su máximo mientras que SIR no.
"""
...
begin
	Random.seed!(2023)
	prob_SEIRS, p_SEIRS = optimizar_params(SEIRS, [0.0001, 0.0001, 10, 10, 10, 200], tf2, costo(tf2, weekly_cases, 3), SAMIN,
		lb = zeros(6), ub = [0.0005, 0.0005, 100, 100, 500, 500], generator = (prob, q) -> remake(prob, u0 = [1-q[1]-q[2], q[1], q[2], 0], p = q[3:6]), maxiters = 50000)
end
...
begin
	...
	prob_SEIRS_C, p_SEIRS_C = optimizar_params(SEIRS_C, [p_SEIRS[1:3]..., 1, p_SEIRS[4:6]...], tf2, costo(tf2, weekly_cases, 3), SAMIN,
		lb = zeros(7), ub = [0.0005, 0.0005, 100, 100, 100, 500, 500], generator = (prob, q) -> remake(prob, u0 = [1-q[1]-q[2], q[1], q[2], 0], p = q[3:7]), maxiters = 50000)
end
...
# ╔═╡ 4d877819-01ba-474c-b0a2-8b6e38241546
p_SIR
