...
# ╔═╡ 71d28b41-43f7-4624-98a7-b392e8b6b13b
plot(sel[!,"Date_reported"], sel[!, "New_cases"])
...
# ╔═╡ f66a824f-6a98-42e4-8458-e34af6b8eb70
#weekly_cases = append!(df1[!,2],0) - push!(df1[!,2],0)

# ╔═╡ 88a53934-dde8-4084-9983-d09c22665b19
df1[!,2]

# ╔═╡ 27ac7627-a203-41c0-9711-df1377191a46
plot(df1[!,"Date_reported"], df1[!,"Cumulative_cases"])

# ╔═╡ b5ad315d-d196-4f21-8b99-f8a26fa3079a
plot(df1[!,"Date_reported"], df1[!,"Cumulative_deaths"])
